...
def load_cfg_from_args(description="Config options."):
    ...
    cfg.SAVE_DIR = os.path.join(cfg.SAVE_DIR, f"{cfg.CORRUPTION.DATASET}", f"{cfg.MODEL.ADAPTATION}", f"{cfg.RNG_SEED}")
